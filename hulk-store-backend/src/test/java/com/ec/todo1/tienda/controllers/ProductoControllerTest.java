...
public class ProductoControllerTest {
	...
	String exampleCourseJson = "{\"id\":\"13\",\"nombre\":\"Superheroes\",\"descripcion\":\"Era Marvel de los Comics 1961-1978\"}";
    ...
    private Producto createProducto() {
        ...
        producto.setId(1);
        producto.setNombre("Superheroes");
	...
	public void createStudentCourse() throws Exception {
		ProductoResponse mockProducto = new ProductoResponse(1,"Superheroes", "Era Marvel de los Comics 1961-1978", new Date(), 10, "url", new BigDecimal(10));
